...
const Hero = () => {
  ...
  return (
    <section className="grid md:grid-cols-2 items-center py-12 px-4 sm:px-8 md:px-12 lg:px-24 xl:px-32 2xl:px-40 gap-8 md:gap-16 relative min-h-[80vh] w-full">
      ...
      <div className="flex flex-col gap-6 md:gap-8 relative animate-fade-in-up md:ml-24 lg:ml-32 xl:ml-40 2xl:ml-48" style={{ zIndex: 10 }}>

        {/* Badge removed */}

        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.1] tracking-tight relative">
        ...
        <p className="text-gray-400 text-sm sm:text-base md:text-lg leading-relaxed max-w-lg font-normal animate-fade-in-up" style={{ animationDelay: '0.2s', opacity: 0 }}>
          {t.hero.description}
        </p>

        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 mt-2 animate-fade-in-up" style={{ animationDelay: '0.4s', opacity: 0 }}>
          <Link href="/install" className="relative overflow-hidden bg-[#8B5CF6] hover:bg-[#7c4dff] text-white font-medium py-3 sm:py-3.5 px-6 sm:px-9 rounded-full transition-all duration-500 ease-out flex items-center justify-center gap-2 hover:shadow-[0_0_25px_rgba(139,92,246,0.6)] hover:-translate-y-1 active:scale-95 text-sm sm:text-[15px] group animate-pulse-glow">
            ...
            <span className="relative z-10">{t.hero.btnDownload}</span>
          </Link>
          <Link href="/docs" className="relative bg-[#1F1D2B] hover:bg-[#2a2838] text-white font-medium py-3 sm:py-3.5 px-6 sm:px-9 rounded-full transition-all duration-500 ease-out border border-white/5 hover:border-purple-500/40 hover:shadow-lg hover:shadow-purple-900/20 hover:-translate-y-1 active:scale-95 text-sm sm:text-[15px] group overflow-hidden">
            ...
            <span className="relative z-10 transition-all duration-300 group-hover:tracking-wide">{t.hero.btnLearnMore}</span>
          </Link>
        </div>

        {/* Stats / Trust Indicators */}
        <div className="flex flex-wrap sm:flex-nowrap items-center gap-6 sm:gap-8 mt-4 pt-6 sm:pt-8 border-t border-white/5 relative animate-fade-in-up" style={{ animationDelay: '0.6s', opacity: 0, zIndex: 10 }}>
          <div className="flex flex-col group cursor-default relative">
            <span className="text-xl sm:text-2xl font-bold text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-purple-400 group-hover:to-blue-400 transition-all duration-300">100%</span>
            <span className="text-[10px] sm:text-xs text-gray-500 uppercase tracking-wider group-hover:text-gray-400 transition-colors">{t.hero.stat1}</span>
          ...
          <div className="flex flex-col group cursor-default relative">
            <span className="text-xl sm:text-2xl font-bold text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-blue-400 group-hover:to-cyan-400 transition-all duration-300">P2P</span>
            <span className="text-[10px] sm:text-xs text-gray-500 uppercase tracking-wider group-hover:text-gray-400 transition-colors">{t.hero.stat2}</span>
          ...
          <div className="flex flex-col group cursor-default relative">
            <span className="text-xl sm:text-2xl font-bold text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-pink-400 group-hover:to-purple-400 transition-all duration-300">AES</span>
            <span className="text-[10px] sm:text-xs text-gray-500 uppercase tracking-wider group-hover:text-gray-400 transition-colors">{t.hero.stat3}</span>
