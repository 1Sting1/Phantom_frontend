    ...
    <section className="grid md:grid-cols-2 items-center py-20 px-12 lg:px-24 xl:px-32 2xl:px-40 gap-16 relative min-h-[80vh] w-full">
      ...
      <div className="flex flex-col gap-8 relative animate-fade-in-up md:ml-24 lg:ml-32 xl:ml-40 2xl:ml-48" style={{ zIndex: 10 }}>
        ...
        <div className="flex items-center gap-4 mt-2 animate-fade-in-up" style={{ animationDelay: '0.4s', opacity: 0 }}>
          <Link href="/install" className="relative overflow-hidden bg-[#8B5CF6] hover:bg-[#7c4dff] text-white font-medium py-3.5 px-9 rounded-full transition-all duration-500 ease-out flex items-center gap-2 hover:shadow-[0_0_25px_rgba(139,92,246,0.6)] hover:-translate-y-1 active:scale-95 text-[15px] group animate-pulse-glow">
          ...
          <Link href="/docs" className="relative bg-[#1F1D2B] hover:bg-[#2a2838] text-white font-medium py-3.5 px-9 rounded-full transition-all duration-500 ease-out border border-white/5 hover:border-purple-500/40 hover:shadow-lg hover:shadow-purple-900/20 hover:-translate-y-1 active:scale-95 text-[15px] group overflow-hidden">
